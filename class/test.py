...
import settings
from back_main import BackMain as back
...
class App(customtkinter.CTk):
    ...
    def create_nav_1(self, path):
        ...
        self.home_btn_button = customtkinter.CTkButton(self.nav_1_frame, height=70, text="", fg_color="transparent",
                                                       ...
                                                       command=self.home_mode).grid(row=0, column=0, sticky="nsew")
    ...
    def create_nav_channels(self, path):
        ...
        # 0 1 Server name 
        self.server_name_label = customtkinter.CTkLabel(self.nav_channels_frame, text="Channels",
                                                        font=customtkinter.CTkFont(size=20, weight="bold")).grid(row=0,
                                                                                                                 column=1)
        ...
        # create scrollable label and button frame
        current_dir = os.path.dirname(os.path.abspath(__file__))
        self.scrollable_label_button_frame = ScrollableButtons(self.nav_channels_frame, width=150,
                                                               command=self.label_button_frame_event, corner_radius=0)
        self.scrollable_label_button_frame.grid(row=1, column=1, padx=0, pady=0, sticky="nsew")

        self.scrollable_label_button_frame.add_item("Text", image=customtkinter.CTkImage(
            Image.open(os.path.join(current_dir, "../assets/", "comment-alt.png"))))
        self.scrollable_label_button_frame.add_item("Vocal", image=customtkinter.CTkImage(
            Image.open(os.path.join(current_dir, "../assets/", "megaphone.png"))))
        # -------------------------------------------------------------------------------
    ...
    def create_chat(self, path):
        ...
        self.main_label = customtkinter.CTkLabel(self.chat_frame, text="Chat",
        ...
        # create scrollable label and button frame
        current_dir = os.path.dirname(os.path.abspath(__file__))
        self.scrollable_label_button_frame = ScrollableChat(self.chat_frame, width=100,
                                                            command=self.label_button_frame_event, corner_radius=0)
        self.scrollable_label_button_frame.grid(row=1, column=0, columnspan=3, padx=0, pady=0, sticky="nsew")

        for i in range(back_app.messages.__len__()):  # add items with images
            self.scrollable_label_button_frame.add_item(f"{back_app.messages[i].message}",
                                                        image=customtkinter.CTkImage(
                                                            Image.open(os.path.join(current_dir, "../assets/",
                                                                                    "user.png"))),
                                                        time=f"{back_app.messages[i].time}")


        # 2 2 Input zone 
        self.text_entry = customtkinter.CTkEntry(self.chat_frame, width=500, placeholder_text="Chat").grid(row=2,
                                                                                                           column=0,
                                                                                                           sticky="e")
        ...
        self.send_btn_button = customtkinter.CTkButton(self.chat_frame, text="", fg_color="transparent",
                                                       ...
                                                       command=self.test).grid(row=2, column=1, sticky="ns")
    ...
    def create_nav_friend(self, path):
        ...
        self.send_btn_button = customtkinter.CTkButton(self.nav_friend_frame, text="", fg_color="transparent",
                                                       text_color=("gray10", "gray90"),
                                                       hover_color=("gray70", "gray30"), image=self.send_btn_image,
                                                       command=self.test).grid(row=0, column=1, sticky="nsew")
        ...
        # create scrollable label and button frame
        current_dir = os.path.dirname(os.path.abspath(__file__))
        self.scrollable_label_button_frame = ScrollableButtons(self.nav_friend_frame, width=150,
                                                               command=self.label_button_frame_event, corner_radius=0)
        self.scrollable_label_button_frame.grid(row=1, column=1, padx=0, pady=0, sticky="nsew")
        ...
        self.send_btn_button = customtkinter.CTkButton(self.nav_friend_frame, text="", fg_color="transparent",
                                                       text_color=("gray10", "gray90"),
                                                       hover_color=("gray70", "gray30"), image=self.send_btn_image,
                                                       command=self.test).grid(row=2, column=1, sticky="nsew")
    ...
    def label_button_frame_event(self, item):
        ...
        self.test = customtkinter.CTkLabel(self.nav_channels_frame, text=item,
...
class ScrollableChat(customtkinter.CTkScrollableFrame):
    ...
    def add_item(self, item, image=None):
        button = customtkinter.CTkButton(self, text=f"{self.return_current_time()} | {self.random_username()} :",
                                         width=100, height=24, fg_color=self.random_color(), text_color="black",
                                         hover_color="white",
    ...
    def random_username(self):
        return random.choice([user.username for user in back_app.users])
